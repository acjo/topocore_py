...
On the left hand side are some print outs of some progress logging to see where we are in the computation. As the caption of @fig-persistence-diagram-plots states, we downsampled to 20 points instead of the full 93 on these diagrams.
